...
class _LutGetterBase:
    ...
    def get_range_idx_to_private_obs_LUT(self):
        ...
        #     fp.write(f'range size = {self.rules.RANGE_SIZE} \n')
        #     fp.write(f'hole cards size = {self.rules.N_HOLE_CARDS} \n')
        #     fp.write(f'suits  = {self.rules.N_SUITS} \n')
        #     fp.write(f'ranks  = {self.rules.N_RANKS} \n')
        #     fp.write(f'range_idx_to_hc_lut  = {range_idx_to_hc_lut} \n')
        #     fp.write(f'hc_1d_to_2d_lut  = {hc_1d_to_2d_lut} \n')
        #     fp.write(f'lut = {lut} \n')
